...
минуту.
Диалоги при желании читаются разными голосами — получается аудиоспектакль.
...
* **перенос ударения на проклитику**: «**не́** было», «чему бы то **ни́**
  было» — безударное слово забирает ударение у знаменательного, и глагол
  остаётся без него;
...
Ни одно из правил этой программы не открыто здесь: всё описано в русской
лингвистике задолго до нас, и сделано было только одно — сведено в код для
конкретной пары свободных моделей. Вот работы, к которым правила восходят.

**Фонетическое слово, проклитики и энклитики, редукция безударных гласных,
перенос ударения на предлог и частицу** («не́ был», «на́ воду», «чему бы то
ни́ было»):

* Аванесов Р. И. Русское литературное произношение. М.: Просвещение, 1984
  (6-е изд.; переиздание URSS, 2015).
* Панов М. В. Русская фонетика. М.: Просвещение, 1967.

**Ударение в каждой словоформе** — то, чего не хватает модели, когда она
ошибается в «стро́ишь» при верном «стро́ит»:

* Зализняк А. А. Грамматический словарь русского языка: Словоизменение.
  Около 100 000 слов. М.: Русский язык, 1977 (и последующие издания).

**Интонация вопроса.** Различение ИК-2 (понижение на вопросительном слове:
«Что́ он сказал?») и ИК-3 (подъём в конце, когда вопросительного слова нет:
«Ты пойдёшь?») — это система интонационных конструкций Е. А. Брызгуновой,
и правило программы следует именно ей:
...
* Русская грамматика. Т. 1: Фонетика. Фонология. Ударение. Интонация.
  Словообразование. Морфология / гл. ред. Н. Ю. Шведова. М.: Наука, 1980
  (раздел об интонации — Е. А. Брызгунова).

**Ударение для чтения вслух.** Ближайший родственник этой программы по
задаче, только для живых дикторов:

* Агеенко Ф. Л., Зарва М. В. Словарь ударений для работников радио и
  телевидения / под ред. Д. Э. Розенталя. М., 1967; 5-е изд. — М.: Русский
  язык, 1984 (около 75 000 слов).

**Буква «ё» и знак ударения на письме** — то, вокруг чего построена
вся разметка:

* Правила русской орфографии и пунктуации. Полный академический
  справочник / под ред. В. В. Лопатина. М., 2006, §§ 4, 5, 116
  ([извлечение на сайте ИРЯ РАН](https://ruslang.ru/doc/bukva_jo.pdf)).
...
5. Если нужен **аудиоспектакль** — галочка на вкладке «Озвучка»,
   см. ниже.
...
Обычная аудиокнига читается одним голосом. Если поставить галочку
**Аудиоспектакль**, диалоги будут звучать разными голосами: за каждым
персонажем закрепляется свой, а повествование остаётся за чтецом.

В свободной модели `v5_cis_base` 29 русских голосов, так что на повесть с
полутора десятками говорящих их хватает с запасом.

![Раздача голосов](docs/screenshot-roles.png)

*Вкладка «Озвучка»: галочка «Аудиоспектакль», таблица ролей и раздача голосов.*

**Как это делается.**

1. Кнопка «Найти персонажей в тексте» собирает список говорящих из слов
   автора («— сказал Кузьма») и считает, сколько у кого реплик. Падежные
   формы одного имени склеиваются: «Ане» — это Аня, а не отдельный человек.
2. В таблице ролей каждому назначается голос. Род определяется по тексту
   («— сказала») и подсказывает, из каких голосов выбирать.
3. Программа расставляет говорящих по репликам сама и помечает каждую:
   **точно** — имя названо или проставлено вами, **догадка** — выведено
   чередованием, **пусто** — сказать нечего.
4. Фильтр «говорящие» показывает только спорные места. Цифрами 1–9
   назначается голос, `Tab` перескакивает к следующему неразобранному.

![Разбор говорящих](docs/screenshot-speakers.png)

*Фильтр «говорящие»: для каждой реплики видно, откуда взят говорящий —
«назван в тексте» или «по чередованию», — и сколько осталось неразобранных.*

**Откуда программа знает, кто говорит.** Из шести источников, от самого
надёжного к самому шаткому: имя в словах автора; абзац перед репликой,
кончающийся двоеточием; местоимение при глаголе речи, когда имя названо в
предыдущем абзаце («Первым увидел Кузьма... — Ильич, — сказал он»); род
глагола, когда в сцене человек этого рода один; тот, кому говорили в
предыдущей реплике («сказала она Матвею Ильичу» — отвечать Матвею);
действующее лицо предыдущего
абзаца, когда слов автора нет вовсе («Она открыла корзину… — Это глаза»).
Что осталось — чередование, и только в сцене, где говорящих ровно двое.

На повести в 488 реплик это даёт 249 «точно», 117 догадок и 122 реплики,
которые назначает человек. Чередование проверено на спрятанных именах: 84%.
В сцене на троих оно выключается совсем — пусть лучше останется пусто, чем
машина уверенно соврёт.

**Детских голосов в наборе нет.** Для ребёнка голос взрослой женщины можно
поднять по высоте (столбец «Высота», 1.28 для шестилетней девочки): выходит
не детский голос, а его подобие, слегка мультяшное, — но для нескольких
реплик это лучше взрослого. Тем же способом делается машинный голос:
понижение до 0.90.
