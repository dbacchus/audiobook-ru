...
Сделано, чтобы озвучить собственную повесть, и доведено на слух: почти
всё в описанных ниже правилах появилось после того, как очередное слово
прозвучало не так.
...
Свободные части делают **слово**: RUAccent ставит в нём ударение и решает
«е» или «ё», CMUdict даёт ударение в английском слове, Silero озвучивает то,
что подали. Уровнем выше начинается **фраза**, и там свободного решения нет:
какие слова в этой фразе вообще ударные, какие прислоняются к соседям и
теряют ударение, где проходит граница между ними.

У этого уровня есть классическое имя — **фонетическое слово** (речевой такт):
ударное слово вместе с прилипшими к нему безударными. Проклитики спереди,
энклитики сзади. Почти все правила этой программы описывают именно его:
